...
function App() {
  ...
  async function getMessage() {
    ...
    if (typeof window.ethereum !== "undefined") {
      ...
      try {
        ...
        const name1 = `My name is ${name} and I'm ${age} years old`;
  ...
  return (
    <div className="App">
      ...
      <h2>Metacrafters Backend/Frontend integration</h2>
      {/* <h3>
      ...
      <br /> <br />
      <button onClick={getMessage}>Get Details</button>
      <h2>{message}</h2>
      <br /> <br />
      <button onClick={handleClearMessage}>Clear Details</button>
    </div>
  );
}
